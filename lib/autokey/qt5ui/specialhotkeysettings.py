...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.setMonitorButton = QtWidgets.QPushButton(self.groupBox)
        self.setMonitorButton.setObjectName("setMonitorButton")
        self.horizontalLayout_2.addWidget(self.setMonitorButton)
        self.clearMonitorButton = QtWidgets.QPushButton(self.groupBox)
        ...
        self.setConfigButton = QtWidgets.QPushButton(self.groupBox_2)
        self.setConfigButton.setObjectName("setConfigButton")
        self.horizontalLayout.addWidget(self.setConfigButton)
        self.clearConfigButton = QtWidgets.QPushButton(self.groupBox_2)
